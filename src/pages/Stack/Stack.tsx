...
import {
  ...
  SiGit, SiGithub, SiBootstrap, SiLinux,
  SiSpringboot, SiFastapi, SiPostgresql, SiAnsible, SiGithubactions,
...
const mainStack: StackItem[] = [
  ...
  { Icon: SiSpringboot,    name: 'Spring Boot',    color: '#5a9e33', url: 'https://spring.io/projects/spring-boot' },
  { Icon: SiFastapi,       name: 'FastAPI',        color: '#0a8073', url: 'https://fastapi.tiangolo.com' },
  ...
  { Icon: SiPostgresql,    name: 'PostgreSQL',     color: '#336791', url: 'https://www.postgresql.org' },
  ...
  { Icon: SiAnsible,       name: 'Ansible',        color: '#bb1616', url: 'https://www.ansible.com' },
  { Icon: SiGithubactions, name: 'GitHub Actions', color: '#2076cc', url: 'https://github.com/features/actions' },
]

    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          description: 'Site de réservation de salles en Rust — exercice scolaire : créneaux, formulaires et logique métier. Non déployé.',
          tags: ['Rust', 'HTML/CSS'],
          github: null,
          live: null,
        ...
        },
        {
          ...
          description: 'Site de réservation de places en PHP — projet scolaire axé sur le CRUD et la base de données ; interface volontairement très simple (priorité à la logique, pas au design).',
          tags: ['PHP', 'MySQL'],
          github: null,
          live: null,
          status: 'Projet scolaire',
  ...
  en: {
    ...
    projects: {
      ...
      items: [
        ...
        {
          name: 'Room booking',
          description: 'Room reservation site in Rust — school exercise: time slots, forms and core logic. Not deployed.',
          tags: ['Rust', 'HTML/CSS'],
          github: null,
          live: null,
        ...
        {
          name: 'Cinema booking',
          description: 'Seat booking site in PHP — school project focused on CRUD and the database; deliberately minimal UI (logic first, not polish).',
          tags: ['PHP', 'MySQL'],
          github: null,
          live: null,
          status: 'School project',
